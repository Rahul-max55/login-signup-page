            ...
            <div className="right_form">
                ...
                <div className="all_form">
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="CPassword" className="Scpassword">C Password
                        </label>
                        <button className="submit" type="Submit">SignUp </button>
                        <Link to="/login"><button onClick={() => { return props.Switch_SignUp() }} className="reset submit " type="Reset" >  Login </button >
                        </Link>
                    </form>
                </div>
                <div className="other" >
